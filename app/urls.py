...
urlpatterns = [
    ...
    path('kanbanitem/add/<int:organizerobject_id>/', AddEditItemView.as_view(), name='add_item'),
    path('kanbanitem/add/<int:organizerobject_id>/<int:kanbanitem_id>/', AddEditItemView.as_view(), name='add_item'),
    path('kanbanitem/shift/<str:direction>/<int:organizerobject_id>/<int:kanbanitem_id>/', ShiftKanbanItem.as_view(), name='shift_item'),
    path('<str:item_type>/add/<int:organizerobject_id>/<str:datestr>/', AddEditItemView.as_view(), name='add_item'),
